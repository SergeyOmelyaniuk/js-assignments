...
describe('13-more-tasks', () => {
  it('distinctLettersString should return a new sorted string with distinct letters', () => {
  ...
  it('lowerLetters should return an object of every distinct letters', () => {
  ...
  it('titleCaseConvert should return converted into title case string', () => {
  ...
  it('calcRPN should calculate Reverse Polish notation expression', () => {
